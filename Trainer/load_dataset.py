...
def build_dataset(hf_repo: str = "NV9523/DentalGPT_SFT"):
    ...
    if os.path.exists("dataset_cache") and os.path.isdir("dataset_cache"):
        ...
        train_ds = train_ds.map(create_prompt, batched=True, batch_size=2048)
        eval_ds = eval_ds.map(create_prompt, batched=True, batch_size=2048)
